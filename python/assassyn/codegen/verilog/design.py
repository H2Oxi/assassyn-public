...
"""
            ...
            if isinstance(owner, ExternalModule) and owner not in self.instantiated_external_modules:
                ext_module_name = namify(owner.name)
                inst_name = f"{ext_module_name.lower()}_inst"
                self.append_code('# TODO: this should be generated by our new feature')
